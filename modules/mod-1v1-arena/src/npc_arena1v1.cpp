...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        {
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Leave queue", GOSSIP_SENDER_MAIN, 3, "Are you sure?", 0, false);
        }
        else
        {
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Queue enter 1v1 Arena (Skirmish)", GOSSIP_SENDER_MAIN, 20);
        }
        ...
        else
        {
            if (!player->InBattlegroundQueueForBattlegroundQueueType(bgQueueTypeId))
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Delete my 1v1 Arena team", GOSSIP_SENDER_MAIN, 5, "Are you sure?", 0, false);
            }
