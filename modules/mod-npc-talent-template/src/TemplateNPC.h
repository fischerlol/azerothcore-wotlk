...
{
    ENGINEERING_SKILL = 202,
    JEWELCRAFTING_SKILL = 755
};

enum professionSpells
{
    ENGINEERING_SPELL = 51306,
    JEWELCRAFTING_SPELL = 51311
};
...
static void LearnWeaponSkills(Player* player)
{
    ...
    case CLASS_HUNTER:
        ...
        player->learnSpell(CROSSBOWS);
        player->learnSpell(BOWS);
        //player->learnSpell(ENGINEERING_SPELL, false);
        //player->learnSpell(JEWELCRAFTING_SPELL, false);
        //player->SetSkill(ENGINEERING_SKILL, 0, MIN, MAX);
        //player->SetSkill(JEWELCRAFTING_SKILL, 0, MIN, MAX);
        //player->SetReputation(ASHEN_VERDICT, REP_MAX);
        break;
    case CLASS_DRUID:
        player->learnSpell(TWO_H_MACES);
        player->learnSpell(STAVES);
